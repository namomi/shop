...
class ItemRepositoryTest {
    ...
    public void createItemTest() throws Exception{
        ...
        item.setPrice(10000);
        item.setItemDetail("테스트 상품 상세 설정");
    ...
    public void findByItemNmTest() throws Exception{
        ...
        //when
        List<Item> itemList = itemRepository.findByItemNm("태스트 상품1");
    ...
    @Test
    @DisplayName("nativieQuery 속성을 이요한 상품 조회 테스트")
    public void findByItemDetailByNativeTest() throws Exception{
        //given
        this.createItemList();
